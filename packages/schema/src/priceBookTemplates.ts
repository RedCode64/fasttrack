import type { PriceBookKind, Trade } from "./enums.js";

/**
 * The single source of the trade price-book templates (Plan 5 reconciliation).
 * The live `price_book_templates` table (Plan 2, migration 6) mirrors these 31
 * rows exactly; mobile onboarding seeds each org's book from this module.
 */
